  ...
  - generic [ref=e57]:
    - generic [ref=e60]:
      ...
      - generic [ref=e77]:
        ...
        - generic [ref=e79]:
          - combobox "Appointment Reason" [active] [ref=e80]: Acne
    ...
    - generic [ref=e112]:
      ...
      - heading "Binh Vu Binh Vu Thu Aug 6 8:10 AM Thu Aug 6 8:20 AM Thu Aug 6 8:30 AM Show More" [level=3] [ref=e135]:
        - button "Binh Vu Binh Vu Thu Aug 6 8:10 AM Thu Aug 6 8:20 AM Thu Aug 6 8:30 AM Show More" [ref=e136]:
          - generic [ref=e139]:
            - img "Binh Vu" [ref=e141]
            - generic [ref=e142]:
              - paragraph [ref=e144]: Binh Vu
              - generic [ref=e145]:
                - button "Thu Aug 6 8:10 AM" [ref=e146] [cursor=pointer]:
                  - paragraph [ref=e147]: Thu Aug 6
                  - paragraph [ref=e148]: 8:10 AM
                - button "Thu Aug 6 8:20 AM" [ref=e149] [cursor=pointer]:
                  - paragraph [ref=e150]: Thu Aug 6
                  - paragraph [ref=e151]: 8:20 AM
                - button "Thu Aug 6 8:30 AM" [ref=e152] [cursor=pointer]:
                  - paragraph [ref=e153]: Thu Aug 6
                  - paragraph [ref=e154]: 8:30 AM
...
> 85  |             await this.tndiDateBtn.waitFor({ state: 'visible', timeout: 10_000 });
      |                                    ^ TimeoutError: locator.waitFor: Timeout 10000ms exceeded.
  86  |             await this.tndiDateBtn.click();
  87  |             console.log(`TNDI date clicked`);
  88  | 
  89  |             await this.tndiTimeBtn.waitFor({ state: 'visible', timeout: 10_000 });
