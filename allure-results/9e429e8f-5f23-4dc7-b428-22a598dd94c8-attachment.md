...
- Name: tests\e2e\clients\SINY\cosmetic.spec.js >> SINY Landing — gray service / location >> All top-level reasons from landing >> TC-LAND-S16 — "Routine Skin Screening" → New Patient navigates to Intake Questions
