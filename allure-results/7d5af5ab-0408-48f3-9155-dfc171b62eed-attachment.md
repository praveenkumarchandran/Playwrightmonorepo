...
Locator: locator('[role="option"]').filter({ hasText: 'MI-Michigan' }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="option"]').filter({ hasText: 'MI-Michigan' }).first()
    ...
    - generic [ref=e89]:
      - generic [ref=e90]:
        ...
        - generic [ref=e120]:
          ...
          - generic [ref=e134]:
            - generic [ref=e136]:
              - combobox "State *" [expanded] [active] [ref=e137]: Mich
              - button "Close" [ref=e139] [cursor=pointer]:
                - img [ref=e140]
              - group
            - listbox [ref=e142]:
              - option "MI-Michigan" [ref=e143] [cursor=pointer]
          - generic [ref=e145]:
            - generic: Home Zip *
            - generic [ref=e146]:
...
```ts
  ...
  160 |             await expect(
  161 |                 page.locator('[role="option"]').filter({ hasText: 'MI-Michigan' }).first()
> 162 |             ).toBeVisible();
      |               ^ Error: expect(locator).toBeVisible() failed
  163 |         });
  164 | 
