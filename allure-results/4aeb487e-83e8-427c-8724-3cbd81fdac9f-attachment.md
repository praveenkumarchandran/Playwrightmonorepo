...
- Name: tests\e2e\clients\TNDI\newPatient.spec.js >> Manual entry flow >> TC-INS-05c — Insurance plan search returns results
- Location: tests\e2e\shared\insurance.cases.js:116:13
...
Locator: locator('.MuiAutocomplete-option, [role="option"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.MuiAutocomplete-option, [role="option"]').first()
...
- combobox "Primary Insurance Holder": Blue
- button "Close"
- button "Next"
- text: No options
```
