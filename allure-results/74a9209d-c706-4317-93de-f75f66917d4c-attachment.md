...
- Name: tests\e2e\clients\SINY\cosmetic.spec.js >> Appointment summary panel — patient info page >> TC-APPT-PI-05 — Appointment Type shows "Botox treatment"
- Location: tests\e2e\shared\appointmentSummary.cases.js:154:13
...
Locator: getByText('Botox treatment').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByText('Botox treatment').first()
