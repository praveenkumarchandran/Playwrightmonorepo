...
- Name: tests\e2e\clients\Hopemark\newPatient.spec.js >> Landing page >> Service type navigation from landing >> TC-LAND-SVC — selecting "Psychiatric Evaluation (In-Office)" and clicking New Patient reaches find appointment
  ...
  - generic [ref=e67]:
    - generic [ref=e70]:
      ...
      - generic [ref=e76]:
        ...
        - generic [ref=e78]:
          - combobox "Location" [ref=e79]: Downtown
      ...
      - generic [ref=e87]:
        ...
        - generic [ref=e89]:
          - combobox "Appointment Reason" [ref=e90]: Psychiatric Evaluation (In-Office)
    ...
    - generic [ref=e114]:
      - progressbar [ref=e115]:
        - img [ref=e116]
      - heading "Loading..." [level=6] [ref=e118]
```
