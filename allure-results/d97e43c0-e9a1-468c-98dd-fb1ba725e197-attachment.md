...
- Name: tests\e2e\clients\Hopemark\newPatient.spec.js >> Landing page >> Service type navigation from landing >> TC-LAND-SVC — selecting "Psychiatric Evaluation (Virtual)" and clicking New Patient reaches find appointment
  ...
  - generic [ref=e67]:
    - generic [ref=e70]:
      ...
      - generic [ref=e87]:
        ...
        - generic [ref=e89]:
          - combobox "Appointment Reason" [ref=e90]: Psychiatric Evaluation (Virtual)
