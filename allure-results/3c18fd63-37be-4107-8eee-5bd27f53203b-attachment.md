...
- Name: tests\e2e\booking\create-appointment.spec.js >> SMS consent checkbox >> TC25 — calling twice stays checked
- Location: tests\e2e\booking\shared\patientInfo.cases.js:215:9

# Error details

```
Error: toBeChecked can be only used with Locator object, was called with undefined
```
    ...
    - generic [ref=e89]:
      - generic [ref=e90]:
        ...
        - generic [ref=e120]:
          ...
          - generic [ref=e146]:
            - generic: Home Zip *
            - generic [ref=e147]:
              - textbox "Home Zip *" [ref=e148]
              - group:
                - generic: Home Zip *
          - generic [ref=e151]:
            - generic: How Did You Hear About Us? *
            - generic [ref=e152]:
              - combobox "How Did You Hear About Us? *" [ref=e153]
      ...
      - generic [ref=e158]:
        - generic [ref=e159] [cursor=pointer]:
          - checkbox [checked] [active] [ref=e160]
          - img [ref=e161]
        - paragraph [ref=e163]: I give permission for the practice to contact me via SMS or email. I understand that I can opt out at any time.
...
```ts
  ...
  207 |             await expect(patientPage.smsConsentCheckbox).not.toBeChecked();
  208 |         });
  209 | 
  210 |         test('TC24 — clicking MUI span checks the box', async ({ patientPage }) => {
  211 |             await patientPage.checkSmsConsent();
  212 |             await expect(patientPage.smsConsentCheckbox).toBeChecked();
  213 |         });
  214 | 
...
> 218 |             await expect(patientPage.smsConsentCheckbox).toBeChecked();
      |                                                          ^ Error: toBeChecked can be only used with Locator object, was called with undefined
  219 |         });
  220 | 
  221 |     });
