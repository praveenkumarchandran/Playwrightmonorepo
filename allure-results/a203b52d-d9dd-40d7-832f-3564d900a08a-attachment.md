...
- Name: tests\e2e\clients\TNDI\newPatient.spec.js >> Manual entry flow >> TC-INS-05d — Selecting "Other" as insurance plan reveals the plan name field
- Location: tests\e2e\shared\insurance.cases.js:125:13
...
Locator: locator('input[placeholder="Other Insurance Plan"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('input[placeholder="Other Insurance Plan"]')
