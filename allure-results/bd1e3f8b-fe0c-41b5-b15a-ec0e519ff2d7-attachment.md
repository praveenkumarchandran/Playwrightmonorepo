...
- Name: tests\e2e\clients\SINY\cosmetic.spec.js >> Existing Patient — identity search >> Form fields >> TC-EP-02 — all fields are empty on initial load
- Location: tests\e2e\shared\existingPatient.cases.js:28:13
