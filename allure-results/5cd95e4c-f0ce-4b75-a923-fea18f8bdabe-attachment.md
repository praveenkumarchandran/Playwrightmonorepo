...
- Name: tests\e2e\clients\SINY\cosmetic.spec.js >> Find Appointment — Basic Search filters >> Filter dropdowns >> TC-FA-03 — Provider dropdown defaults to "Any Provider"
- Location: tests\e2e\shared\findAppointment.cases.js:32:13
...
Expected pattern: /any provider/i
Received string:  ""
```
