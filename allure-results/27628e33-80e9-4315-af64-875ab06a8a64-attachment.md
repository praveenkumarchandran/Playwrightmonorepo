...
- Name: tests\e2e\clients\SINY\cosmetic.spec.js >> SINY Landing — gray service / location >> Edge cases >> TC-LAND-S12 — service type dropdown resets when reason changes
- Location: tests\e2e\shared\sinyLanding.cases.js:169:13
...
Call log:
  - waiting for locator('[class*="MuiSelect"], [class*="MuiFormControl"]').filter({ has: locator('label:has-text("Reason"), label:has-text("Service Type"), [class*="MuiInputLabel"]') }).locator('[role="combobox"], .MuiSelect-select').first()
    ...
    - generic [ref=e23]:
      ...
      - generic [ref=e24]:
        ...
        - generic [ref=e28]:
          ...
          - group
        - generic [ref=e37]:
          - combobox "Service Type" [active] [ref=e38]: Botox treatment
