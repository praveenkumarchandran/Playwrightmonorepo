...
- Name: tests\e2e\booking\create-appointment.spec.js >> Date of Birth >> TC10 — fills DOB for a minor
- Location: tests\e2e\booking\shared\patientInfo.cases.js:100:9

# Error details

```
Test timeout of 120000ms exceeded while setting up "patientPage".
```
