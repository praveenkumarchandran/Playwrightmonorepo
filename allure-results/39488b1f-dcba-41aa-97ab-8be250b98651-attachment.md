...
- Name: tests\e2e\clients\CVD\newPatient.spec.js >> Invalid input format validation >> TC-PI-VAL-04 — email with no @ symbol keeps form on page
- Location: tests\e2e\shared\patientInfo.cases.js:110:9
