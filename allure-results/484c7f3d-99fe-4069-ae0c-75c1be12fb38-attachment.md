...
- Name: tests\e2e\clients\SINY\medical.spec.js >> Form validation >> TC-PI-34 — partial form (only firstName) still shows errors
- Location: tests\e2e\shared\patientInfo.cases.js:294:9
