...
- Name: tests\e2e\clients\SINY\cosmetic.spec.js >> SINY Landing — gray service / location >> Path B — gray service → gray location → popup >> TC-LAND-S08 — unavailability popup closes with X button
- Location: tests\e2e\shared\sinyLanding.cases.js:102:13
