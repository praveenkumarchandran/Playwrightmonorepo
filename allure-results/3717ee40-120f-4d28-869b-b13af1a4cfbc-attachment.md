...
- Name: tests\e2e\clients\CVD\newPatient.spec.js >> Invalid input format validation >> TC-PI-VAL-02 — too-short phone number keeps form on page
- Location: tests\e2e\shared\patientInfo.cases.js:91:9
