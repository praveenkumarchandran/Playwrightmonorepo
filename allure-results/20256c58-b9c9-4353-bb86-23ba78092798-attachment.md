...
- Name: tests\e2e\booking\create-appointment.spec.js >> Form validation >> TC28 — invalid email shows validation error
- Location: tests\e2e\booking\shared\patientInfo.cases.js:242:9
